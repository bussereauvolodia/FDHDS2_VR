...
template<> SUBSTANCECORE_API UScriptStruct* StaticStruct<FSubstanceGraphDesc>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USubstanceInstanceFactory_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USubstanceInstanceFactory_CreateGraphInstance, "CreateGraphInstance" }, // 2870981955
		{ &Z_Construct_UFunction_USubstanceInstanceFactory_GetGraphDescs, "GetGraphDescs" }, // 3947818827
		{ &Z_Construct_UFunction_USubstanceInstanceFactory_GetGraphInstances, "GetGraphInstances" }, // 2172846093
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USubstanceInstanceFactory_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstanceInstanceFactory_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstanceInstanceFactory_h_Statics::EnumInfo[] = {
		{ ESubstanceGenerationMode_StaticEnum, TEXT("ESubstanceGenerationMode"), &Z_Registration_Info_UEnum_ESubstanceGenerationMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2019920683U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstanceInstanceFactory_h_Statics::ScriptStructInfo[] = {
		{ FSubstanceGraphDesc::StaticStruct, Z_Construct_UScriptStruct_FSubstanceGraphDesc_Statics::NewStructOps, TEXT("SubstanceGraphDesc"), &Z_Registration_Info_UScriptStruct_SubstanceGraphDesc, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSubstanceGraphDesc), 2716496075U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstanceInstanceFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USubstanceInstanceFactory, USubstanceInstanceFactory::StaticClass, TEXT("USubstanceInstanceFactory"), &Z_Registration_Info_UClass_USubstanceInstanceFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USubstanceInstanceFactory), 828193587U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstanceInstanceFactory_h_1156147672(TEXT("/Script/SubstanceCore"),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstanceInstanceFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstanceInstanceFactory_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstanceInstanceFactory_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstanceInstanceFactory_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstanceInstanceFactory_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstanceInstanceFactory_h_Statics::EnumInfo));

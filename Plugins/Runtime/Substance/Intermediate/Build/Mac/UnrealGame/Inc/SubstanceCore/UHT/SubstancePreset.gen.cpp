...
template<> SUBSTANCECORE_API UScriptStruct* StaticStruct<FSubstancePreset>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FSubstancePreset_Statics::NewProp_SavedPresetString = { "SavedPresetString", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSubstancePreset, SavedPresetString), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubstancePreset_Statics::NewProp_SavedPresetString_MetaData), Z_Construct_UScriptStruct_FSubstancePreset_Statics::NewProp_SavedPresetString_MetaData) };
	...
	struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstancePreset_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstancePreset_h_Statics::ScriptStructInfo[] = {
		{ FSubstancePreset::StaticStruct, Z_Construct_UScriptStruct_FSubstancePreset_Statics::NewStructOps, TEXT("SubstancePreset"), &Z_Registration_Info_UScriptStruct_SubstancePreset, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSubstancePreset), 75361625U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstancePreset_h_2120009806(TEXT("/Script/SubstanceCore"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstancePreset_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceCore_Classes_SubstancePreset_h_Statics::ScriptStructInfo),
		nullptr, 0);

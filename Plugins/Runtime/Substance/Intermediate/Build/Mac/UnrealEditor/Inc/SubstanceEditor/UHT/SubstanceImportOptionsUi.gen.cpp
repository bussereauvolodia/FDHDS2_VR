...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USubstanceImportOptionsUi_Statics::NewProp_ParentMaterial = { "ParentMaterial", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USubstanceImportOptionsUi, ParentMaterial), Z_Construct_UClass_UMaterial_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USubstanceImportOptionsUi_Statics::NewProp_ParentMaterial_MetaData), Z_Construct_UClass_USubstanceImportOptionsUi_Statics::NewProp_ParentMaterial_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_USubstanceImportOptionsUi_Statics::NewProp_InstanceName = { "InstanceName", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USubstanceImportOptionsUi, InstanceName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USubstanceImportOptionsUi_Statics::NewProp_InstanceName_MetaData), Z_Construct_UClass_USubstanceImportOptionsUi_Statics::NewProp_InstanceName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_USubstanceImportOptionsUi_Statics::NewProp_MaterialName = { "MaterialName", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USubstanceImportOptionsUi, MaterialName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USubstanceImportOptionsUi_Statics::NewProp_MaterialName_MetaData), Z_Construct_UClass_USubstanceImportOptionsUi_Statics::NewProp_MaterialName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_USubstanceImportOptionsUi_Statics::NewProp_InstanceDestinationPath = { "InstanceDestinationPath", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USubstanceImportOptionsUi, InstanceDestinationPath), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USubstanceImportOptionsUi_Statics::NewProp_InstanceDestinationPath_MetaData), Z_Construct_UClass_USubstanceImportOptionsUi_Statics::NewProp_InstanceDestinationPath_MetaData) };
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceEditor_Public_SubstanceImportOptionsUi_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceEditor_Public_SubstanceImportOptionsUi_h_Statics::EnumInfo[] = {
		{ ESubstanceMaterialParentType_StaticEnum, TEXT("ESubstanceMaterialParentType"), &Z_Registration_Info_UEnum_ESubstanceMaterialParentType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 591295207U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceEditor_Public_SubstanceImportOptionsUi_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USubstanceImportOptionsUi, USubstanceImportOptionsUi::StaticClass, TEXT("USubstanceImportOptionsUi"), &Z_Registration_Info_UClass_USubstanceImportOptionsUi, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USubstanceImportOptionsUi), 392155958U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceEditor_Public_SubstanceImportOptionsUi_h_3165916789(TEXT("/Script/SubstanceEditor"),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceEditor_Public_SubstanceImportOptionsUi_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceEditor_Public_SubstanceImportOptionsUi_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceEditor_Public_SubstanceImportOptionsUi_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_Substance_Source_SubstanceEditor_Public_SubstanceImportOptionsUi_h_Statics::EnumInfo));
